...
const checks = [
  ...
  },
  {
    ...
    expectOutput: ["Total: 109 tests in 3 files", "acceptance page runs no-mock AQ01 through the real workbench API"],
    successMessage: "Playwright discovery registered 109 tests"
  },
  {
