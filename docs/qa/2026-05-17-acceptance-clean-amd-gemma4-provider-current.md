...
Generated: 2026-05-17T14:11:02+00:00
...
| --- | --- | ---: | --- | ---: | --- | --- | --- |
| AQ01 | pass | 24 | code, register | 30 nodes / 58 edges | - | - | Who reads or writes regGCVM_L2_CNTL? |
| AQ02 | pass | 24 | code, doc, register | 27 nodes / 39 edges | - | - | Which fields of GCVM_L2_CNTL are set in MxGPU gfx_v11_0.c? |
| AQ03 | pass | 24 | code, doc, register | 43 nodes / 82 edges | - | - | Where is IH_RB_CNTL configured, and which fields are modified? |
| AQ04 | pass | 24 | code, doc, pdf, register | 14 nodes / 17 edges | - | - | Which code paths reference SDMA0_QUEUE0_RB_CNTL or SDMA1_QUEUE0_RB_CNTL? |
...
| AQ06 | pass | 24 | code, doc, register | 23 nodes / 34 edges | - | - | Given WREG32_SOC15(GC, 0, regGCVM_L2_CNTL, tmp), explain the resolved register entity and macro expansion chain. |
