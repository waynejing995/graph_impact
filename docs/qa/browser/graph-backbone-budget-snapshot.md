  ...
  - generic [ref=e2]:
    ...
    - main [ref=e14]:
      ...
      - complementary [ref=e90]:
        ...
        - generic [ref=e96]:
          - paragraph [ref=e155]:
            - code [ref=e156]: function:linux-amdgpu:drivers/gpu/drm/amd/amdgpu/amdgpu.h:amdgpu_device_rreg reads register:GC:unknown:unknown:GCVM_L2_CNTL
          - paragraph [ref=e157]:
            - code [ref=e158]: function:linux-amdgpu:drivers/gpu/drm/amd/amdgpu/amdgpu.h:amdgpu_device_rreg reads register:GMC:unknown:unknown:GMC_V11_0_INIT_GOLDEN_REGISTERS
          - paragraph [ref=e159]:
            - code [ref=e160]: README.md#gim contains README.md#box-gim
          - paragraph [ref=e161]:
            - code [ref=e162]: README.md#gim contains README.md#box-gpu-iov-initialization
          - paragraph [ref=e163]:
            - code [ref=e164]: README.md#gim contains README.md#box-gpu-scheduling-for-world-switch
          - paragraph [ref=e165]:
            - code [ref=e166]: README.md#gim contains README.md#box-hang-detection-and-virtual-function-level-reset-flr
          - paragraph [ref=e167]:
            - code [ref=e168]: README.md#gim contains README.md#box-pf-vf-hand-shake-and-other-gpu-utilities
          - paragraph [ref=e169]:
            - code [ref=e170]: README.md#gim contains README.md#box-virtual-function-configuration-and-enablement
          - paragraph [ref=e171]:
            - code [ref=e172]: README.md#box-gim relates_to README.md#box-gpu-iov-initialization
          - paragraph [ref=e173]:
            - code [ref=e174]: README.md#box-gim relates_to README.md#box-gpu-scheduling-for-world-switch
          - paragraph [ref=e175]:
            - code [ref=e176]: README.md#box-gim relates_to README.md#box-hang-detection-and-virtual-function-level-reset-flr
          - paragraph [ref=e177]:
            - code [ref=e178]: README.md#box-gim relates_to README.md#box-pf-vf-hand-shake-and-other-gpu-utilities
