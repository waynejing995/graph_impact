...
- 2026-05-21 labeled semantic quality evaluation is recorded in `docs/qa/2026-05-21-semantic-rerank-labeled-eval.json` and `.md`. It runs `docs/qa/semantic-rerank-eval-set.jsonl` against the current DB and passes `5/5` cases with two provider-vector cases and MRR `0.67`.
