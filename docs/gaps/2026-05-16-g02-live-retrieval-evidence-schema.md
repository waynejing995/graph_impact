...
- Clean AMD acceptance artifact `docs/qa/2026-05-17-acceptance-clean-amd-gemma4-provider-current.json` records AQ01-AQ09 as `9/9` passed against `/tmp/asip-clean-amd-gemma4-provider-2026-05-17-final.db`; source types include `code/register` for AQ01, `code/doc/register` for AQ02/AQ03/AQ06, `code/doc/pdf/register` for AQ04/AQ05, `pdf/register` for AQ07/AQ09, and `doc/register` for AQ08.
